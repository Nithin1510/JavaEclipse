...
class OrderDetailsTest {
	...
	void testShowBooks() throws BookNotFoundException {
		String author = "John";
		List<Book> booksByAuthor = Arrays.asList(book6, book2, book3, book1, book4, book5);
		...
		List<Book> expected = Arrays.asList(book6, book2, book3, book1, book4, book5);
		// call the method to be tested. this line will be called first
